...
const commonController = () => {
	...
	function ChangeCulture(language: any) {
		...
		var redirectUrl:any = '/_common-settings/ChangeCulture?culture=' + language + '&url=' + originalUrl;
	...
	function setCookie(c_name: any, value: any, exdays: any) {
		...
		var c_value:any = escape(value) + ((exdays == null) ? "" : "; expires=" + exdate.toUTCString());
